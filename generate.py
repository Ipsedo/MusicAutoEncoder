...
def main() -> None:
    ...
    with th.no_grad():
        ...
        means = th.rand(hidden_channel) * 2. - 1.

        #random_data = normal_dist.rec_multivariate_gen(hidden_length, nb_sec, hidden_channel, means, cov_mat, eta=0.1)

        #random_data = normal_dist.rec_multivariate_different_gen(hidden_length, nb_sec, hidden_channel, eta=0.9, beta=0.1)
        ...
        random_data = word_embedding.gen_embedding("/home/samuel/Documents/MusicAutoEncoder/res/fasttext_196_fr.bin",
